      ...
      case "smoothToTarget":
        ...
        break;
                  ...
                  for (let o of entities) {
                    if (o.master === this.body.master && o.label.includes("Mixed Trap Drone")) {
                      o.define(Class.trap);
                      o.define({
                        BODY: {
                          RANGE: o.RANGE * 0.5,
                          HEALTH: o.health.max * 1.125
                        }
                      });
                      this.children = [];
                      this.body.children = [];
                      this.body.master.children = [];
                    }
                  }
                  break;
      case "bound":
...
let k = (loc) => {
  ...
  let choose = ran.choose([
    Class.dominatorGunner,
    Class.dominatorOverlord,
    Class.dominatorPounder
...
if (ArenaClosed !== true) {
  ...
  if(ArenaClosed == true){
    ...
    setTimeout(function() {
      ...
      setTimeout(function(){sockets.broadcast("New objective: Survive")}, 2000
                )
      ...
      setInterval(function() {
        if (loops < 16) {
          ...
          o.define(Class.ac);//put whatever you want to spawn at the end here
          o.team = -100;
